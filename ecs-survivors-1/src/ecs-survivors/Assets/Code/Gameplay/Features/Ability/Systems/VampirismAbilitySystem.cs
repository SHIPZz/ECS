...
{
    public class VampirismAbilitySystem : IExecuteSystem
    {
        ...
        public VampirismAbilitySystem(GameContext game, IArmamentFactory armamentFactory, IGetClosestEnemyService getClosestEnemyService)
        {
            _getClosestEnemyService = getClosestEnemyService;
            _armamentFactory = armamentFactory;
            
            _abilities = game.GetGroup(GameMatcher
                .AllOf(GameMatcher.VampirismAbility, GameMatcher.CooldownUp));
        ...
        public void Execute()
        {
            ...
            foreach (GameEntity ability in _abilities.GetEntities(_buffer))
            {
                ...
                _armamentFactory.CreateVampirismBolt(1, hero.WorldPosition)
                    .AddFollowTargetId(closestEnemy.Id)
                    .AddArmamentProducerId(hero.Id)
