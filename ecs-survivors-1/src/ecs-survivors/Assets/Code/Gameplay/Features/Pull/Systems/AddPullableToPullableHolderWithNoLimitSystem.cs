...
{
    public class AddPullableToPullableHolderWithNoLimitSystem : IExecuteSystem
    {
        private readonly IGroup<GameEntity> _pullables;
        private readonly IGroup<GameEntity> _pullableHolders;

        public AddPullableToPullableHolderWithNoLimitSystem(GameContext game)
        {
            ...
            _pullableHolders = game.GetGroup(GameMatcher
                .AllOf(
                    ...
                    GameMatcher.Id)
                .NoneOf(GameMatcher.MaxPullTargetHold));
        }
        ...
        {
            return pullable.Id != pullableHolder.Id && !pullableHolder.PullTargetList.Contains(pullable.Id); 
        }
