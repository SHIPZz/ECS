...
{
    public class ApplyVampirismStatusSystem : IExecuteSystem
    {
        private readonly IGroup<GameEntity> _statuses;
        private readonly List<GameEntity> _buffer = new(32);

        public ApplyVampirismStatusSystem(GameContext game)
        {
        ...
        public void Execute()
        {
            ...
            {
                CreateEntity.Empty()
                    .AddStatChange(Stats.Hp)
                    .AddTargetId(status.ProducerId)
