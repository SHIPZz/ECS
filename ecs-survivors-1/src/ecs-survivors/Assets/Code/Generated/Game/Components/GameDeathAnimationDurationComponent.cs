...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Death.DeathAnimationDuration deathAnimationDuration { get { return (Code.Gameplay.Features.Death.DeathAnimationDuration)GetComponent(GameComponentsLookup.DeathAnimationDuration); } }
    ...
    public GameEntity AddDeathAnimationDuration(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Death.DeathAnimationDuration)CreateComponent(index, typeof(Code.Gameplay.Features.Death.DeathAnimationDuration));
