...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Armament.EffectSetups effectSetups { get { return (Code.Gameplay.Features.Armament.EffectSetups)GetComponent(GameComponentsLookup.EffectSetups); } }
    ...
    public GameEntity AddEffectSetups(System.Collections.Generic.List<Code.Gameplay.Features.Effects.EffectSetup> newValue) {
        ...
        var component = (Code.Gameplay.Features.Armament.EffectSetups)CreateComponent(index, typeof(Code.Gameplay.Features.Armament.EffectSetups));
