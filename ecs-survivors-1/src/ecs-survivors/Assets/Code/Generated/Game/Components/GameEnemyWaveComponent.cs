...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Enemies.EnemyWave enemyWave { get { return (Code.Gameplay.Features.Enemies.EnemyWave)GetComponent(GameComponentsLookup.EnemyWave); } }
    public int EnemyWave { get { return enemyWave.Value; } }
    public bool hasEnemyWave { get { return HasComponent(GameComponentsLookup.EnemyWave); } }

    public GameEntity AddEnemyWave(int newValue) {
        var index = GameComponentsLookup.EnemyWave;
        var component = (Code.Gameplay.Features.Enemies.EnemyWave)CreateComponent(index, typeof(Code.Gameplay.Features.Enemies.EnemyWave));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceEnemyWave(int newValue) {
        var index = GameComponentsLookup.EnemyWave;
        var component = (Code.Gameplay.Features.Enemies.EnemyWave)CreateComponent(index, typeof(Code.Gameplay.Features.Enemies.EnemyWave));
        component.Value = newValue;
