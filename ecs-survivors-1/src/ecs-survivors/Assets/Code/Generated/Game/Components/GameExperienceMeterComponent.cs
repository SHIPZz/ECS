...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.LevelUp.Behaviour.ExperienceMeter ExperienceMeter { get { return experienceMeter.Value; } }
    public bool hasExperienceMeter { get { return HasComponent(GameComponentsLookup.ExperienceMeter); } }

    public GameEntity AddExperienceMeter(Code.Gameplay.Features.LevelUp.Behaviour.ExperienceMeter newValue) {
    ...
    public GameEntity ReplaceExperienceMeter(Code.Gameplay.Features.LevelUp.Behaviour.ExperienceMeter newValue) {
        var index = GameComponentsLookup.ExperienceMeter;
        var component = (Code.Gameplay.Features.LevelUp.ExperienceMeterComponent)CreateComponent(index, typeof(Code.Gameplay.Features.LevelUp.ExperienceMeterComponent));
        component.Value = newValue;
