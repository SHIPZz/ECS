...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Follow.FollowMaxDistance followMaxDistance { get { return (Code.Gameplay.Features.Follow.FollowMaxDistance)GetComponent(GameComponentsLookup.FollowMaxDistance); } }
    ...
    public GameEntity AddFollowMaxDistance(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Follow.FollowMaxDistance)CreateComponent(index, typeof(Code.Gameplay.Features.Follow.FollowMaxDistance));
