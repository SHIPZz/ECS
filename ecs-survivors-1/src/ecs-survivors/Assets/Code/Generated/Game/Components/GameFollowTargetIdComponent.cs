...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Follow.FollowTargetId followTargetId { get { return (Code.Gameplay.Features.Follow.FollowTargetId)GetComponent(GameComponentsLookup.FollowTargetId); } }
    ...
    public GameEntity AddFollowTargetId(int newValue) {
        ...
        var component = (Code.Gameplay.Features.Follow.FollowTargetId)CreateComponent(index, typeof(Code.Gameplay.Features.Follow.FollowTargetId));
