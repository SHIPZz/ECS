...
public partial class GameEntity {
    ...
    static readonly Code.Gameplay.Features.Statuses.PeriodicDamageStatus periodicDamageStatusComponent = new Code.Gameplay.Features.Statuses.PeriodicDamageStatus();
