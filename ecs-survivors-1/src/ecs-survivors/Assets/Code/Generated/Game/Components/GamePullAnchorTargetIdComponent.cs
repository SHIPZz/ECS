...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Pull.PullAnchorTargetId pullAnchorTargetId { get { return (Code.Gameplay.Features.Pull.PullAnchorTargetId)GetComponent(GameComponentsLookup.PullAnchorTargetId); } }
    ...
    public GameEntity AddPullAnchorTargetId(int newValue) {
        ...
        var component = (Code.Gameplay.Features.Pull.PullAnchorTargetId)CreateComponent(index, typeof(Code.Gameplay.Features.Pull.PullAnchorTargetId));
