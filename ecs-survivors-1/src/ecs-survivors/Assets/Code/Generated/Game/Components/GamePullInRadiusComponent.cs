...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Pull.PullInRadius pullInRadius { get { return (Code.Gameplay.Features.Pull.PullInRadius)GetComponent(GameComponentsLookup.PullInRadius); } }
    ...
    public GameEntity AddPullInRadius(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Pull.PullInRadius)CreateComponent(index, typeof(Code.Gameplay.Features.Pull.PullInRadius));
