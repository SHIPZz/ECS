...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Lifetime.RestoreHp restoreHp { get { return (Code.Gameplay.Features.Lifetime.RestoreHp)GetComponent(GameComponentsLookup.RestoreHp); } }
    ...
    public GameEntity AddRestoreHp(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Lifetime.RestoreHp)CreateComponent(index, typeof(Code.Gameplay.Features.Lifetime.RestoreHp));
