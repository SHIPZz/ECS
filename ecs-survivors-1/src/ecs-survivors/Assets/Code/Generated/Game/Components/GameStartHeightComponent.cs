...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Movement.StartHeight startHeight { get { return (Code.Gameplay.Features.Movement.StartHeight)GetComponent(GameComponentsLookup.StartHeight); } }
    ...
    public GameEntity AddStartHeight(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Movement.StartHeight)CreateComponent(index, typeof(Code.Gameplay.Features.Movement.StartHeight));
