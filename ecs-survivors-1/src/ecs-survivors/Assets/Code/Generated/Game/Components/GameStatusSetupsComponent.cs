...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Statuses.StatusSetupsComponent statusSetups { get { return (Code.Gameplay.Features.Statuses.StatusSetupsComponent)GetComponent(GameComponentsLookup.StatusSetups); } }
    ...
    public GameEntity AddStatusSetups(System.Collections.Generic.List<Code.Gameplay.Features.Statuses.StatusSetup> newValue) {
        ...
        var component = (Code.Gameplay.Features.Statuses.StatusSetupsComponent)CreateComponent(index, typeof(Code.Gameplay.Features.Statuses.StatusSetupsComponent));
