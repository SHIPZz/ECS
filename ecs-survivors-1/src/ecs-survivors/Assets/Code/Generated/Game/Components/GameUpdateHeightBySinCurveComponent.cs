...
public partial class GameEntity {
    ...
    static readonly Code.Gameplay.Features.Movement.UpdateHeightBySinCurve updateHeightBySinCurveComponent = new Code.Gameplay.Features.Movement.UpdateHeightBySinCurve();
